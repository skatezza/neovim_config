...
-- vim.api.nvim_set_keymap('n', '<C-k>', ':call smooth_scroll#up(&scroll, 4, 2)<cr>', {noremap = true, silent = true})
-- vim.api.nvim_set_keymap('n', '<C-j>', ':call smooth_scroll#down(&scroll, 4, 2)<cr>', {noremap = true, silent = true})
